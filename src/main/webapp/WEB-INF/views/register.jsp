...
<form:form commandName="user" cssClass="registerForm form-signin">
	...
	<input type="checkbox" name="tos" class="tos" /> I agree to <a href="tos.html" onclick='window.open(this.href, null, "height=768,width=1024,status=no,toolbar=no,menubar=no,location=no"); return false'>Terms of Service</a><br /><br />
