...
<body>
	...
	<div class="container">
		...
		<p>[You must be at least 18 years of age to use this website. By
			...
			warrant and represent that you are at least 18 years of age.</p>

		<p>This website uses cookies. By using this website and agreeing
			to these terms and conditions, you consent to our use of cookies in
			accordance with the terms of privacy policy.</p>

		<h2>License to use website</h2>

		<p>Unless otherwise stated, Jiri Pinkas and/or his licensors own
		...
		<p>You may view, download and print content from the website for
			personal or commercial use, subject to the restrictions set out below
			and elsewhere in these terms and conditions.</p>
		...
		<p>You must not use this website to copy, store, host, transmit,
		...
		<p>You must not conduct any systematic or automated data
			...
			mining, data extraction and data harvesting) on or in relation to
			this website without our express written consent.</p>


		<h2>Restricted access</h2>

		<p>Access to certain areas of this website is restricted. Jiri
			Pinkas reserves the right to restrict access to areas of this
			website, or indeed this entire website, at his discretion.</p>

		<p>If we provide you with a user ID and password to enable you to
		...
		<p>We may disable your user ID and password in our sole discretion
			without notice or explanation.</p>

		<h2>User content</h2>

		<p>In these terms and conditions, "your user content" means
		...
		<p>Your user content must not be illegal or unlawful, must not
			...
			giving rise to legal action whether against you or Jiri Pinkas or a
			third party (in each case under any applicable law).</p>

		<p>You must not submit any user content to the website that is or
			has ever been the subject of any threatened or actual legal
			proceedings or other similar complaint.</p>

		<p>Jiri Pinkas reserves the right to edit or remove any material
			submitted to this website, or stored on our servers, or hosted or
			published upon this website.</p>

		<h2>No warranties</h2>

		<p>This website is provided "as is" without any representations or
			warranties, express or implied. Jiri Pinkas makes no representations
		...
		<p>Without prejudice to the generality of the foregoing paragraph,
			Jiri Pinkas does not warrant that:</p>
		...
		<p>Jiri Pinkas will not be liable to you (whether under the law of
			contact, the law of torts or otherwise) in relation to the contents
			of, or use of, or otherwise in connection with, this website:</p>
		...
		<p>These limitations of liability apply even if Jiri Pinkas has
		...
		<p>Nothing in this website disclaimer will exclude or limit any
			...
			Jiri Pinkas liability in respect of any:</p>

		<ul>
			<li>death or personal injury caused by [NAME'S] negligence;</li>
			<li>fraud or fraudulent misrepresentation on the part of [NAME];
				or</li>
			<li>matter which it would be illegal or unlawful for [NAME] to
		...
		<p>By using this website, you agree that the exclusions and
			...
			reasonable. If you do not think they are reasonable, you must not use
			this website.</p>
		...
		<p>You hereby indemnify Jiri Pinkas and undertake to keep him
			...
			paid by Jiri Pinkas to a third party in settlement of a claim or
			dispute on the advice of his legal advisers) incurred or suffered by
			his arising out of any breach by you of any provision of these terms
			and conditions, or arising out of any claim that you have breached
			any provision of these terms and conditions.</p>

		<h2>Breaches of these terms and conditions</h2>

		<p>Without prejudice to Jiri Pinkas's other rights under these
			terms and conditions, if you breach these terms and conditions in any
			way, Jiri Pinkas may take such action as he deems appropriate to deal
			...
			website and/or bringing court proceedings against you.</p>

		<h2>Variation</h2>

		<p>We may revise these terms and conditions from time-to-time.
			...
			familiar with the current version.</p>

		<h2>Assignment</h2>

		<p>Jiri Pinkas may transfer, sub-contract or otherwise deal with
			his rights and/or obligations under these terms and conditions
			without notifying you or obtaining your consent.</p>

		<p>You may not transfer, sub-contract or otherwise deal with your
			rights and/or obligations under these terms and conditions.</p>

		<h2>Severability</h2>

		<p>If a provision of these terms and conditions is determined by
			...
			be deleted, and the rest of the provision will continue in effect.</p>

		<h2>Entire agreement</h2>

		<p>These terms and conditions constitute the entire agreement
			between you and Jiri Pinkas in relation to your use of this website,
		...
		<p>These terms and conditions will be governed by and construed in
			accordance with appropriate laws, and any disputes relating to these
			terms and conditions will be subject to the exclusive jurisdiction of
			the courts of Czech Republic.</p>
