...
<link rel="icon" type="image/png" href="${pageContext.request.contextPath}/diplomas/images/logo.png"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/diplomas/jgraduate/css/jPicker.css" type="text/css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/diplomas/jgraduate/css/jgraduate.css" type="text/css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/diplomas/svg-editor.css" type="text/css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/diplomas/spinbtn/JQuerySpinBtn.css" type="text/css"/>

<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/jquery.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/js-hotkeys/jquery.hotkeys.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/jquerybbq/jquery.bbq.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/svgicons/jquery.svgicons.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/jgraduate/jquery.jgraduate.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/spinbtn/JQuerySpinBtn.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/touch.js"></script>

  <script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/svgedit.compiled.js"></script>

<!-- you can load extensions here -->
<!-- <script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/extensions/ext-helloworld.js"></script> -->

<!-- always minified scripts -->
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/diplomas/jgraduate/jpicker.js"></script>


<script type="text/javascript">
$(document).ready(function() {
	svgEditor.loadFromString('${svgFile}');
});
</script>
...
// 		request.getrequ
	...
	<div>
		<img src="${pageContext.request.contextPath}/diplomas/images/save.png" class="btn_save push_button tool_button_disabled" />
		<script type="text/javascript">
			$(document).ready(function() {
				$(".btn_save").click(function(e) {
					var svg = svgCanvas.svgCanvasToString();
					var name = $(".diploma_name").text();
					$.post('<%= new UrlPathHelper().getOriginatingRequestUri(request) + "?" + request.getQueryString() %>', {svg: svg, name: name}, function(data) {
	 					window.close();
					});
				});
				$(".diploma_name").click(function(e) {
					var name = prompt("Enter diploma name", $(this).text());
					if(name != null) {
						$(this).text(name);
					}
				});
